"""construct_food_safety URL Configuration
...
from construct_food_safety import settings
...
urlpatterns = [
    ...
    url(r'^Predict_FoodSafety_Type/$', remoteuser.Predict_FoodSafety_Type, name="Predict_FoodSafety_Type"),
    ...
    url(r'^View_FoodType_Type_Ratio/$', serviceprovider.View_FoodType_Type_Ratio, name="View_FoodType_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_FoodSafety_Type/$', serviceprovider.View_Prediction_Of_FoodSafety_Type, name="View_Prediction_Of_FoodSafety_Type"),
